...
export class formResourceService {
  ...
  public formform: formPromiseService;
  public form: formPromiseService;
  public refresh: EventEmitter<formRefreshValue>;
  ...
  constructor(
    ...
    @Optional() public resourcesService: formResources
  ) {
    this.isLoading = true;
  ...
  initialize() {
    console.warn('formResourceService.initialize() has been deprecated.');
  }
  ...
  setResource(resourceId: any) {
    ...
    this.form = new formPromiseService(this.resourceUrl);
    this.resource = { data: {} };
  }
  ...
  loadForm() {
    ...
    this.formform = new formPromiseService(this.formUrl);
    this.isLoading = true;
    this.formLoading = this.formform
      .loadForm()
      .then(
        (form: any) => {
          this.form = form;
  ...
  loadParents() {
    ...
    if (!this.resourcesService) {
      console.warn(
        'You must provide the formResources within your application to use nested resources.'
      );
      return Promise.resolve([]);
    }
  ...
  loadResource() {
    ...
    this.isLoading = true;
    this.resourceLoading = this.form
  ...
  save(resource: any) {
    const form = resource._id ? this.form : this.formform;
    return form
